...
public class StudyPostController {
    ...
    public String list(@ModelAttribute PageRequest pageRequest, Model model, @AuthenticationPrincipal CustomUserDetail loginUser) {
    ...
    @GetMapping("/create")
    public String createForm(Model model, @AuthenticationPrincipal CustomUserDetail loginUser) {
        // LoginUser loginUser = (LoginUser) session.getAttribute("loginUser");
    ...
    public String detail(@PathVariable Long postId, Model model, @AuthenticationPrincipal CustomUserDetail loginUser) {
        // LoginUser loginUser = (LoginUser) session.getAttribute("loginUser");
        ...
        model.addAttribute("canProc", canProc);
        model.addAttribute("canReq", canReq);
