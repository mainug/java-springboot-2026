...
- 이미지 표시
  ...
  https://github.com/user-attachments/assets/77c5e2ea-2bef-46fa-8d78-0ecede0afa00
...
- Postman 테스트
  ...
  ```json
  {
    "accessToken": "eyJhbGciOiJIUzM4NCJ9.eyJzdWIiOiJhZG1pbiIsInVzZXJJZCI6MSwibmFtZSI6ImFkbWluIiwicm9sZSI6IlJPTEVfQURNSU4iLCJpYXQiOjE3NzczNDQ4MDMsImV4cCI6MTc3NzM0ODQwM30.hOb6Y6Cf0sYYrwRbhoVPniCXsQse9j9gHTNMhJOaRM3xHLOz-Ir83TPLOuv3nzQG",
    "loginId": "admin",
    "name": "admin",
    "role": "ROLE_ADMIN",
    "tokenType": "Bearer",
...
- powershell에서 구글클라이언트아이디와 비밀키를 윈도우 환경변수에 저장

  ```powershell
  # PowerShell을 이용한 OS 환경 변수 저장 (보안 유지)
  PS C:\Users\Admin> setx GOOGLE_CLIENT_ID "본인_구글클라이언트_아이디"
  ...
  # 파워 쉘 재시작 후 확인
  PS C:\Users\Admin> echo $env:GOOGLE_CLIENT_ID
  PS C:\Users\Admin> echo $env:GOOGLE_CLIENT_SECRET
  ```
